...
public class ProductController {
    ...
    @PostMapping("/{id}")
    public ResponseEntity<?> create(@RequestBody ProductRequest request, @RequestHeader(name = "Authorization") String access_token, @PathVariable String id) {
    ...
    public ResponseEntity<?> update(@RequestHeader(name = "Authorization") String access_token, @RequestBody Product request, @RequestParam String id ) {
        Claims jwtPayload = jwtUtils.decodeAccessToken(access_token);
        Date currentDate = new Date();
